...
function __ZN12_GLOBAL__N_119CheerpStringBuilder11processCharERjS1_h(Larg0,Marg0,Larg1){
	...
	a:if((Larg1&255)<192){
		if((L$psink|0)===0){
			if(Larg1<<24<=-16777216)___assert_fail(1068660|0,tmp0,77,tmp1);
			;
			__ZZN12_GLOBAL__N_117do_syscall_writevEPK5ioveclE9codepoint=tmp4;
		}else{
			if((tmp4&192|0)!==128)___assert_fail(1068548|0,tmp0,63,tmp1);
			;
		...
		if((L$psink|0)!==0)___assert_fail(1068672|0,tmp0,88,tmp1);
		;
		if((Larg1&255)<224){
			tmp2=31;
			L$psink=1;
