...
var CaptchaPanel = function () {
  ...
  return _createClass(CaptchaPanel, [{
    key: "configuration",
    get: function get() {
    ...
    key: "init",
    value: function init() {
      this.sendMessage('sq.getConfigurationBranch', {
        plugin: this._domain
      }).then(this.processConfigurationReceived)["catch"](ignore);
    }
  }, {
    key: "run",
    value: function run() {
      var _this = this;
      this._panelHeader = dom('h1', {
        className: 'seoquake-captcha-header'
      }, this.t('sqCaptcha_header'));
      this._panelText = dom('p', {
        className: 'seoquake-captcha-text'
      });
      this._panelCheckboxes = dom('div', {
        className: 'seoquake-captcha-checkboxes'
      });
      this._panel = dom('div', {
        className: 'seoquake-captcha-panel'
      }, dom('div', {
        className: 'seoquake-captcha-panel_inner'
      }, [this._panelHeader, this._panelText, this._panelCheckboxes]));
    ...
    value: function handleConfigurationReceived(configuration) {
      ...
      this.sendMessage('sq.getPluginParameters', {
        plugin: ''
      }).then(this.processParametersReceived)["catch"](ignore);
    }
  }, {
    ...
    value: function handleCheckboxChange(event) {
      ...
      this.sendMessage(action, {
        id: id,
        plugin: this._domain
      }).then(this.processParameterUpdated)["catch"](ignore);
...
},{"to-camel-case":48}],17:[function(require,module,exports){
'use strict';
...
},{"../lib/ignore":27,"./Chain":7,"./appendText":9,"./clearValue":10,"./correctZIndex":11,"./createElement":12,"./emptyElement":13,"./getElementText":14,"./getOffset":15,"./hasAttribute":16,"./hasClass":17,"./isBodyReady":18,"./isChild":19,"./parseMarkdown":21,"./pixelValue":22,"./qualifyURL":23,"./removeElement":24,"./setContent":25,"./setText":26,"dom-element":39}],21:[function(require,module,exports){
'use strict';
...
},{"extend":43}],22:[function(require,module,exports){
'use strict';
...
},{"html-entities":44}],32:[function(require,module,exports){
'use strict';
...
},{"to-space-case":37}],36:[function(require,module,exports){
...
},{"to-no-case":36}],38:[function(require,module,exports){
/**
...
},{"dom-element-css":34,"dom-element-value":38,"to-camel-case":40}],40:[function(require,module,exports){
arguments[4][35][0].apply(exports,arguments)
},{"dup":35,"to-space-case":42}],41:[function(require,module,exports){
arguments[4][36][0].apply(exports,arguments)
},{"dup":36}],42:[function(require,module,exports){
arguments[4][37][0].apply(exports,arguments)
},{"dup":37,"to-no-case":41}],43:[function(require,module,exports){
'use strict';
...
},{"./lib/html4-entities.js":45,"./lib/html5-entities.js":46,"./lib/xml-entities.js":47}],45:[function(require,module,exports){
...
},{"to-space-case":50}],49:[function(require,module,exports){
